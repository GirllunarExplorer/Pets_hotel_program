...
class Coupon:
    ...
    def input_coupon_code(self):
        code = self.coupon_code.split()
        first_box = self.driver.find_element_by_id("CN1")
        first_box.send_keys("", code[0])
        second_box = self.driver.find_element_by_id("CN2")
        second_box.send_keys("", code[1])
        third_box = self.driver.find_element_by_id("CN3")
        third_box.send_keys("", code[2])
        fourth_box = self.driver.find_element_by_id("CN4")
...
print petshotel_coupon_retrieval("0422 2065 1575 5318")